...
CREATE INDEX CONCURRENTLY idx_audio_tracks_composer_publisher
...
CREATE INDEX CONCURRENTLY idx_audio_tracks_composer_record_label
...
CREATE INDEX CONCURRENTLY idx_audio_tracks_publisher_record_label
...
CREATE INDEX CONCURRENTLY idx_audio_tracks_composer_publisher_label
...
CREATE INDEX CONCURRENTLY idx_audio_tracks_isrc_exact
...
CREATE INDEX CONCURRENTLY idx_audio_tracks_status_composer
ON audio_tracks (status, composer)
WHERE composer IS NOT NULL;

CREATE INDEX CONCURRENTLY idx_audio_tracks_status_publisher
...
CREATE INDEX CONCURRENTLY idx_audio_tracks_composer_covering
ON audio_tracks (composer, id, artist, title, album, year)
WHERE composer IS NOT NULL;

-- Covering index for publisher queries
CREATE INDEX CONCURRENTLY idx_audio_tracks_publisher_covering
...
CREATE INDEX CONCURRENTLY idx_audio_tracks_complete_xmp
...
CREATE INDEX CONCURRENTLY idx_audio_tracks_any_xmp
