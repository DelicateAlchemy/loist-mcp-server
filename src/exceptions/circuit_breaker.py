...
class CircuitBreakerConfig:
    ...
    recovery_timeout: float = field(default_factory=lambda: float(os.getenv('CIRCUIT_BREAKER_RECOVERY_TIMEOUT', '60.0')))
    success_threshold: int = field(default_factory=lambda: int(os.getenv('CIRCUIT_BREAKER_SUCCESS_THRESHOLD', '3')))
    timeout: float = field(default_factory=lambda: float(os.getenv('CIRCUIT_BREAKER_TIMEOUT', '30.0')))
