...
FORMAT_PRESETS: Dict[str, Dict[str, PresetConfig]] = {
    "mp3": {
        ...
        "compact": PresetConfig(
            ...
            ffmpeg_args=("-codec:a", "libmp3lame", "-b:a", "128k"),
    ...
    "wav": {
        "broadcast": PresetConfig(
            ...
            ffmpeg_args=("-acodec", "pcm_s24le", "-ar", "48000"),
            sample_rate=48000,
            bit_depth=24,
        ),
        "cd": PresetConfig(
    ...
    "flac": {
        ...
        "fast": PresetConfig(
            ...
            ffmpeg_args=("-codec:a", "flac", "-compression_level", "0"),
        ),
    },
    "aac": {
        "high": PresetConfig(
            ...
            ffmpeg_args=("-codec:a", "aac", "-b:a", "256k"),
    ...
    "ogg": {
        "high": PresetConfig(
            ...
            ffmpeg_args=("-codec:a", "libvorbis", "-qscale:a", "8"),
            estimated_bitrate=256,
        ),
        "standard": PresetConfig(
            name="standard",
            description="Standard quality Vorbis (Q5, ~160 kbps VBR)",
            ffmpeg_args=("-codec:a", "libvorbis", "-qscale:a", "5"),
